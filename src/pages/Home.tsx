...
export default function Home() {
  return (
    <div className="flex flex-col overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-[95vh] flex items-center pt-28 md:pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-10 -left-10 z-20 bg-brand-yellow p-8 rounded-2xl shadow-xl hidden md:block max-w-[240px]">
              <Sparkles className="text-brand-orange mb-3" size={32} />
              <p className="font-display font-bold text-brand-green text-lg leading-tight">
