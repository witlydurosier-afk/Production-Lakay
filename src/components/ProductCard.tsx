...
const ProductCard: React.FC<ProductCardProps> = ({ product, delay = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-[2.5rem] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-slate-100 flex flex-col h-full"
    >
